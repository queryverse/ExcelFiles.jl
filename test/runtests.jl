...
for (df, names) in full_dfs
    ...
    @test df[9] == [Date(2015,3,3), DateTime(2015,2,4,10,14), Date(1988,4,9), ExcelReaders.Time(15,2,0)]
    @test df[10] == [Date(1965,4,3), DateTime(1950,8,9,18,40), ExcelReaders.Time(19,0,0), DataValues.NA]
